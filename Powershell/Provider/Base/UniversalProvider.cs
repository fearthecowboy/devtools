...
namespace CoApp.Provider.Base {
    ...
    public class UniversalProvider<T> :
        ...
        /// </summary>
        /// <returns> Overrides of this method should return an object that has properties and fields decorated with parsing attributes similar to a cmdlet class or a <see
        ///    cref="System.Management.Automation.PseudoParameterDictionary" /> . The default implemenation returns null. </returns>
        ...
        ///   New-PSDrive cmdlet.
        /// </summary>
        /// <returns> Implementors of this method should return an object that has properties and fields decorated with parsing attributes similar to a cmdlet class or a <see
        ///    cref="System.Management.Automation.PseudoParameterDictionary" /> . The default implemenation returns null. </returns>
        ...
        /// <returns> If the drive can be removed then the drive that was passed in is returned. If the drive cannot be removed, null should be returned and an exception is written to the <see
        ///    cref="System.Management.Automation.Provider.CmdletProvider.WriteError(ErrorRecord)" /> method. The default implementation returns the drive that was passed. </returns>
        /// <remarks>
        ...
        /// <param name="path"> If the path was specified on the command line, this is the path to the item to get the dynamic parameters for. </param>
        /// <returns> Overrides of this method should return an object that has properties and fields decorated with parsing attributes similar to a cmdlet class or a <see
        ///    cref="System.Management.Automation.PseudoParameterDictionary" /> . The default implemenation returns null. (no additional parameters) </returns>
        ...
        /// <param name="recurse"> Tells the provider to recurse sub-containers when copying. </param>
        /// <returns> Overrides of this method should return an object that has properties and fields decorated with parsing attributes similar to a cmdlet class or a <see
        ///    cref="System.Management.Automation.PseudoParameterDictionary" /> . </returns>
        /// <remarks>
        ...
        protected string gcn(string path) {
            if (string.IsNullOrEmpty(path)) {
                throw new CoAppException("path is null");
            }
        ...
        /// </summary>
        /// <param name="path"> If the path was specified on the command line, this is the path to the item to get the dynamic parameters for. </param>
        /// <returns> An object that has properties and fields decorated with parsing attributes similar to a cmdlet class or a <see
        ///    cref="System.Management.Automation.PseudoParameterDictionary" /> . </returns>
        /// <remarks>
        ...
        /// <returns> An object that has properties and fields decorated with parsing attributes similar to a cmdlet class or a <see
        ///    cref="System.Management.Automation.PseudoParameterDictionary" /> . Null can be returned if no dynamic parameters are to be added. </returns>
        /// <remarks>
        ///   The default implementation returns null.
        /// </remarks>
        ...
        /// <param name="property"> An PSObject which contains a collection of the names and values of the properties to be set. </param>
        /// <remarks>
        ...
        /// <param name="destinationPath"> The path to the item on which to copy the property to. </param>
        /// <param name="destinationProperty"> The destination property to copy to. </param>
        /// <returns> An object that has properties and fields decorated with parsing attributes similar to a cmdlet class or <see
        ///    cref="System.Management.Automation.PseudoParameterDictionary" /> . Null can be returned if no dynamic parameters are to be added. </returns>
        /// <remarks>
        ///   The default implementation returns null.
        /// </remarks>
